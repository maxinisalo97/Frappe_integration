<?php
$string['pluginname'] = 'Frappe Integration';
$string['frappe_api_url'] = 'Frappe API URL';
$string['frappe_api_url_desc'] = 'Enter the base URL for the Frappe API, e.g., https://example.com/';
